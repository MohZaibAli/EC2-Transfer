...
public class SubscriptionIndividualApi {
    ...
    private com.squareup.okhttp.Call subscriptionsPostValidateBeforeCall(Subscription body, String contentType, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<Subscription> subscriptionsPostWithHttpInfo(Subscription body, String contentType) throws ApiException {
        com.squareup.okhttp.Call call = subscriptionsPostValidateBeforeCall(body, contentType, null, null);
    ...
    public com.squareup.okhttp.Call subscriptionsPostAsync(Subscription body, String contentType, final ApiCallback<Subscription> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = subscriptionsPostValidateBeforeCall(body, contentType, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Subscription>(){}.getType();
