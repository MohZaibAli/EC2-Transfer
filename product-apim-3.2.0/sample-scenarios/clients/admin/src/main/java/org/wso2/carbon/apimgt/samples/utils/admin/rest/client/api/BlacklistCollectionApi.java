...
public class BlacklistCollectionApi {
    ...
    private com.squareup.okhttp.Call throttlingBlacklistGetCall(String accept, String ifNoneMatch, String ifModifiedSince, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/throttling/blacklist".replaceAll("\\{format\\}","json");
    ...
    public BlockingConditionList throttlingBlacklistGet(String accept, String ifNoneMatch, String ifModifiedSince) throws ApiException {
        ApiResponse<BlockingConditionList> resp = throttlingBlacklistGetWithHttpInfo(accept, ifNoneMatch, ifModifiedSince);
        return resp.getData();
    }
     ...
     * @param ifNoneMatch Validator for conditional requests; based on the ETag of the formerly retrieved variant of the resource (Will be supported in future).  (optional)
     * @param ifModifiedSince Validator for conditional requests; based on Last Modified header of the formerly retrieved variant of the resource (Will be supported in future).  (optional)
     * @return ApiResponse&lt;BlockingConditionList&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<BlockingConditionList> throttlingBlacklistGetWithHttpInfo(String accept, String ifNoneMatch, String ifModifiedSince) throws ApiException {
        com.squareup.okhttp.Call call = throttlingBlacklistGetValidateBeforeCall(accept, ifNoneMatch, ifModifiedSince, null, null);
        Type localVarReturnType = new TypeToken<BlockingConditionList>(){}.getType();
     ...
     */
    public com.squareup.okhttp.Call throttlingBlacklistGetAsync(String accept, String ifNoneMatch, String ifModifiedSince, final ApiCallback<BlockingConditionList> callback) throws ApiException {
    ...
    private com.squareup.okhttp.Call throttlingBlacklistPostCall(BlockingCondition body, String contentType, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call throttlingBlacklistPostValidateBeforeCall(BlockingCondition body, String contentType, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public BlockingCondition throttlingBlacklistPost(BlockingCondition body, String contentType) throws ApiException {
        ApiResponse<BlockingCondition> resp = throttlingBlacklistPostWithHttpInfo(body, contentType);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<BlockingCondition> throttlingBlacklistPostWithHttpInfo(BlockingCondition body, String contentType) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call throttlingBlacklistPostAsync(BlockingCondition body, String contentType, final ApiCallback<BlockingCondition> callback) throws ApiException {
