...
public class AdvancedPolicyCollectionApi {
    ...
    private com.squareup.okhttp.Call throttlingPoliciesAdvancedGetCall(String accept, String ifNoneMatch, String ifModifiedSince, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/throttling/policies/advanced".replaceAll("\\{format\\}","json");
    ...
    private com.squareup.okhttp.Call throttlingPoliciesAdvancedPostCall(AdvancedThrottlePolicy body, String contentType, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
