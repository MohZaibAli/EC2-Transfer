...
public class SyatemScopesApi {
     ...
     */
    public com.squareup.okhttp.Call systemScopesScopeNameGetCall(String scopeName, String username, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/system-scopes/{scopeName}"
            .replaceAll("\\{" + "scopeName" + "\\}", apiClient.escapeString(scopeName.toString()));
    ...
    private com.squareup.okhttp.Call systemScopesScopeNameGetValidateBeforeCall(String scopeName, String username, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = systemScopesScopeNameGetCall(scopeName, username, progressListener, progressRequestListener);
        return call;
    ...
    public ScopeSettingsDTO systemScopesScopeNameGet(String scopeName, String username) throws ApiException {
        ApiResponse<ScopeSettingsDTO> resp = systemScopesScopeNameGetWithHttpInfo(scopeName, username);
        return resp.getData();
    }
    ...
    public ApiResponse<ScopeSettingsDTO> systemScopesScopeNameGetWithHttpInfo(String scopeName, String username) throws ApiException {
        com.squareup.okhttp.Call call = systemScopesScopeNameGetValidateBeforeCall(scopeName, username, null, null);
     ...
     */
    public com.squareup.okhttp.Call systemScopesScopeNameGetAsync(String scopeName, String username, final ApiCallback<ScopeSettingsDTO> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = systemScopesScopeNameGetValidateBeforeCall(scopeName, username, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ScopeSettingsDTO>(){}.getType();
