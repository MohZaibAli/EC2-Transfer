...
public class APIMMigrationServiceComponent {
    ...
    protected void activate(ComponentContext context) {
        ...
        log.info("0CodeAPI Manager migration component successfully activated.");
    }
    ...
    protected void deactivate(ComponentContext context) {
        log.info("0CodeAPI Manager migration bundle is deactivated");
    }
    ...
    protected void setRegistryService(RegistryService registryService) {
        if (log.isDebugEnabled()) {
            log.debug("Setting RegistryService for 0CodeAPI Manager migration");
        }
    ...
    protected void setRealmService(RealmService realmService) {
        log.debug("Setting RealmService for 0CodeAPI Manager migration");
    ...
    protected void setTenantRegistryLoader(TenantRegistryLoader tenantRegLoader) {
        log.debug("Setting TenantRegistryLoader for 0CodeAPI Manager migration");
