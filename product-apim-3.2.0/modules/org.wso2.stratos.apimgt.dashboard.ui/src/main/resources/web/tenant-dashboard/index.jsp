        ...
        <%@ page import="org.wso2.carbon.utils.ServerConstants" %>
            <%@ page import="org.wso2.carbon.ui.CarbonUIUtil" %>
                <link href="../tenant-dashboard/css/dashboard-common.css" rel="stylesheet" type="text/css"
                    media="all" />
                <% Object param=session.getAttribute("authenticated"); String passwordExpires=(String)
                    session.getAttribute(ServerConstants.PASSWORD_EXPIRATION); boolean
                    hasModMgtPermission=CarbonUIUtil.isUserAuthorized(request, "/permission/admin/manage/add/module" );
                    boolean
                    hasServiceMgtPermission=CarbonUIUtil.isUserAuthorized(request, "/permission/admin/manage/add/service"
                    ); boolean
                    hasWebAppMgtPermission=CarbonUIUtil.isUserAuthorized(request,"/permission/admin/manage/manage/webapp");
                    boolean loggedIn=false; if (param !=null) { loggedIn=(Boolean) param; } %>

                    <div id="passwordExpire">
                        <% if (loggedIn && passwordExpires !=null) { %>
                            <div class="info-box">
                                <p>Your password expires at <%=passwordExpires%>. Please change by visiting <a
                    ...
                    <div id="middle">
                        <div id="workArea">
                            ...
                            <h2 class="dashboard-title">0CodeAPI Manager quick start dashboard</h2>
                                        ...
                                        <div class="tip-content-lifter">
                                            <% if (hasWebAppMgtPermission) { %>
                                                ...
                                                <% } else { %>
                                                    ...
                                                    <% } %>
                                                        <p>Web Application hosting features in API Manager supports
                                                            deployment of Jaggery Applications. Deployed Webapps can be
                                                            easily managed using the Webapp management facilities
                                                            available in the management console.</p>
                                                ...
                                                <% } else { %>
                                                    ...
                                                    <% } %>
                                                        <p>Tryit tool can be used as a simple Web Service client which
                                                            can be used to try your services within Server itself.</p>
