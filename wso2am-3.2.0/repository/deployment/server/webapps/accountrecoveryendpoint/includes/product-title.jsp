...
<% if ("Manager".equals(request.getAttribute("headerTitle"))) { %>
  <div class="product-title">
    <div class="theme-icon inline auto transparent product-logo" style="width: auto !important; line-height: 0;">
      <img src="libs/theme/assets/images/0CodeAPI.webp" />
    </div>
    <h1 class="product-title-text">Manager</h1>
  </div>
<% } else {
