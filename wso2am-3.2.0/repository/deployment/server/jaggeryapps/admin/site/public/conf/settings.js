...
const AppConfig = {
    app: {
        ...
        origin: {
            host: 'alphav1.zerocodeapi.com', // Used to construct the loopback origin,
    ...
    idp: {
        origin: 'https://alphav1.zerocodeapi.com:9443',
        checkSessionEndpoint: 'https://alphav1.zerocodeapi.com:9443/oidc/checksession',
    },
};
